...
public class MainMenuScreen extends AbstractScreen {
    ...
    public MainMenuScreen() {
        skin = screenMgr.getAssets().get(SKIN_FILE);
        backgroundTexture = screenMgr.getAssets().get(BACKGROUND_TEXTURE_FILE);
        keyPressSound = screenMgr.getAssets().get(KEY_PRESS_SOUND_FILE);
    ...
    public void render(float delta) {
        ...
        screenMgr.getBatch().draw(backgroundTexture, 0, 0, Constants.V_WIDTH, Constants.V_HEIGHT);
